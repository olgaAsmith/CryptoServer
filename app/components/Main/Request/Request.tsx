    ...
    <section className={styles.request}>
      <form className={styles.request__form}>
        ...
        <input
          ...
          className={`${styles.request__input} button`}
        ></input>
        <input
          type="number"
          placeholder="Телефон"
        ...
        <button
          ...
          className={`${styles.request__submit} button button_blue link`}
        >
          Отправить заявку
        </button>
      </form>
      ...
      <div className={styles.request__info}>
        <h2 style={localBebas.style} className={styles.request__title}>
          отправить заявку на покупку/продажу usdt
        </h2>
        ...
        <Link href="/" style={localBebas.style} className={`${styles.request__reg} button link`}>
          Регистрация
        </Link>
      </div>
    </section>
